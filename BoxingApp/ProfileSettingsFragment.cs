...
namespace BoxingApp
{
    public class ProfileSettingsFragment : NavigationFragment
    {
        ...
        private void DeleteProfile(object sender, System.EventArgs e)
        {
            SettingsHelper.DeleteProfile(_spinnerProfiles.SelectedItem.ToString());
        }
        ...
        private void SaveProfile(object sender, System.EventArgs e)
        {
           ...
           var numRounds = int.Parse(_editTxtNumOfRounds.Text);
            ...
            {
                Settings = new Settings(prep, round, rest, numRounds, maxCombo, screenOn, new List<Sound>())
            };

            SettingsHelper.SaveProfileSettings(profileToSave);
        }

        private void AddProfile(object sender, System.EventArgs e)
        {
